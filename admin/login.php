...
/**
 * Admin Login Page
 * Separate from Google OAuth - uses username/password
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!checkBruteForceLockout($ip)) {
        $error = 'Juda ko\'p urinishlar. Iltimos 15 daqiqadan keyin qayta urinib ko\'ring.';
...
<head>
    ...
    <title>Admin Kirish - WebHub</title>
...
<body>
    <div class="login-container">
        <div class="glass-card login-card">
            <div class="logo">WebHub Admin</div>
            <h1>Xush kelibsiz</h1>
            <p class="subtitle">Admin panelga kirish</p>
